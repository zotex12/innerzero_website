...
- **Legal research summaries.** With the right offline [knowledge pack](/features/knowledge-packs) installed, you can search a local reference database without internet access.
- **Letter drafting.** Brief client context, draft a letter, iterate. Nothing leaves the machine.

What doesn't work as well:

- **Frontier-model reasoning on complex case law.** Local models are good but not at the level of Claude Opus 4.8 on the hardest tasks. Offline capability is the tradeoff.
...
| Frontier-model quality | Local best (Qwen3, Gemma3, gpt-oss) | Frontier (Opus 4.8, GPT-5.6) |
