...
Click the microphone icon in InnerZero and start talking. Zero uses local speech recognition (faster-whisper) to transcribe your words, then a fast [local AI](/what-is-local-ai) model to generate a response, then local text-to-speech (Kokoro) to speak the answer.
...
## What can I do with voice mode?

Voice mode isn't just for simple questions. Zero has the same capabilities in [voice mode](/features/voice) as in text chat:
...
## What is the voice experience like?

Zero's default voice is powered by Kokoro, a lightweight text-to-speech model. It sounds natural and clear. There are 25 voice options to choose from in Settings.
...
<PostImage
  ...
  alt="InnerZero voice mode showing the glowing orb that reacts while you speak, with the microphone control and quick or thorough response toggle below it"
  width={2555}
  height={1349}
  caption="Voice mode: the orb reacts while Zero listens, thinks, and speaks."
/>

## What does optional cloud voice add?
...
## How do I get started with voice mode?
