...
- **Offline reference.** Install a [knowledge pack](/blog/knowledge-packs-explained) and the AI can cross-check facts against an [offline Wikipedia](/features/knowledge-packs) copy. Useful when you are revising and not sure whether a half-remembered fact is right.
