...
All dates and policy quotes in this post reflect the author's reading of each vendor's public terms at the time of writing. Last verified: 2026-05-05.
...
What this means for InnerZero users. If you use your own Anthropic [API key](/features/cloud-ai) with InnerZero in Cloud mode, your prompts are not feeding into training. Anthropic keeps them briefly for abuse monitoring, then deletes them. You can read the current terms at Anthropic's own documentation pages (linked from their website).

Verify here: https://www.anthropic.com/legal/commercial-terms (last verified: 2026-05-05)
...
Verify here: https://openai.com/enterprise-privacy/ (last verified: 2026-05-05)
...
Verify here: https://ai.google.dev/gemini-api/terms (last verified: 2026-05-05)
...
Verify here: https://platform.moonshot.ai/docs/agreement/user-agreement (last verified: 2026-05-05)
...
For API usage with Anthropic, OpenAI, and Google's paid tier, you're opted out by default. For consumer products, check the account settings. OpenAI's ChatGPT has a clear toggle. Google's Gemini app has one in its Gemini Apps Activity settings. Anthropic's Claude.ai has been adjusting theirs over time.
