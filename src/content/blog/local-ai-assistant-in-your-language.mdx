...
InnerZero ships with 26 interface languages as of the current version. The set covers most of the widely spoken languages on desktop:
...
<PostImage
  ...
  alt="InnerZero general settings with the Interface Language dropdown open, listing languages such as English, French, Spanish, German, Italian, and Portuguese with native names"
  width={2557}
  height={1342}
  caption="The Interface Language picker in Settings, with each language shown in its native name."
/>
...
InnerZero supports 26 interface languages as of the current version, covering English, French, Spanish, German, Italian, Portuguese, Dutch, Polish, Russian, Ukrainian, Chinese (Simplified and Traditional), Japanese, Korean, Arabic, Hebrew, Hindi, Turkish, Vietnamese, Thai, Swedish, Indonesian, Persian, and Urdu. More are added over time.
...
Yes. All 26 languages are part of the free InnerZero download. There is no separate purchase for [language support](/features/languages).
