...
Good news: you can run [Ollama](/blog/ollama-desktop-app) on one machine and InnerZero on another. The AI runs on the hardware with the GPU. The interface runs wherever you want.
...
The [setup wizard](/features/setup) will still detect your local hardware for tier assignment. But you can pull larger models on the remote machine manually through Ollama if your remote hardware supports them.
