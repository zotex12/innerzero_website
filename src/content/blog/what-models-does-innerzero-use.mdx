...
InnerZero also supports optional cloud AI if you want more powerful reasoning. You can bring [your own API keys](/blog/claude-opus-4-7-byo-keys) for providers like OpenAI, Anthropic, Google, or [DeepSeek](/models). Your keys go directly to the provider. InnerZero never touches the API traffic.
