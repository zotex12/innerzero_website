...
description: "InnerZero is a free, private AI assistant that runs entirely on your Mac using Apple Silicon. Signed and notarised, it keeps all your data on-device."
date: "2026-06-12"
...
Yes. On Apple Silicon Macs, InnerZero runs models on the Metal GPU for fast responses. It uses [Ollama](https://ollama.com) under the hood to manage and run open-source models like the Qwen3 and Gemma3 families, and it [picks a model](/features/setup) size that suits your Mac on first launch.
...
InnerZero for Mac requires macOS 14 Sonoma or later on an Apple Silicon Mac (M1 or newer). The app's own floor is 4 GB of RAM and 2 GB of free disk space, which every Apple Silicon Mac clears comfortably, and 16 GB or more gives a noticeably better experience with larger models. You will also want a few gigabytes of free space for the AI model, which downloads automatically on first launch.
