...
<PostImage
  ...
  alt="InnerZero Voice page with the speech-to-text panel on the left, the text-to-speech panel on the right, and the voice orb above them"
  width={2557}
  height={1348}
  caption="The Voice page: speech-to-text on the left, text-to-speech on the right, each usable on its own."
/>
...
The local text-to-speech panel includes 25 voices, with an adjustable speaking speed. An optional cloud voice is available too but is off by default.
