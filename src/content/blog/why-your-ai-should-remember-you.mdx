...
Cloud AI can't do this properly. Sure, some services have added "[memory](/blog/ai-that-remembers)" features. But that memory lives on their servers. It's governed by their privacy policy. And it's fundamentally limited because the company has to be careful about what they store and how they use it.

## What is local AI memory?

InnerZero takes a different approach. Your AI builds a [local memory](/features/memory) database that lives on your hard drive. It's a SQLite file. You own it completely.
...
## How does InnerZero's memory work?
...
## Why is local memory private by design?
...
## What does local memory mean in practice?
