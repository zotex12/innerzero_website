...
<PostImage
  ...
  alt="InnerZero My Privacy page showing the Offline, Private, and Cloud mode cards, the local connection log, and a privacy snapshot of what stays on your machine"
  width={2555}
  height={1349}
  caption="The My Privacy page: pick a mode, watch the connection log, and see exactly what stays local."
/>
...
Accounts exist for optional features like the Business Licence and cloud plans. The local AI assistant doesn't need one.
...
InnerZero has an optional cloud mode for people who want access to more capable AI models like Claude, GPT-4, or [DeepSeek](/models). This is completely off by default.
