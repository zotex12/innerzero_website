...
**Qwen (Alibaba Cloud).** The [Qwen3](/models) family. Strong all-rounders available in multiple sizes from 4B to 235B parameters. Apache 2.0 licence. InnerZero uses Qwen3 as its main AI brain.
