...
> - Optional BYO-key access to a frontier model like Claude Opus or Gemini Pro for synthesis tasks where a frontier model earns its keep, without an InnerZero proxy in the path
