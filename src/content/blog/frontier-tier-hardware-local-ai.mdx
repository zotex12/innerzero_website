...
**A realistic frontier-tier build is £5,000 on the low end, £15,000 to £30,000 on the high end.** It depends on whether you are using consumer GPUs (RTX 4090 x 4) or workstation GPUs (RTX 6000 Ada, A100, H100 territory), and whether the build is for inference only or training.
...
For everyone else: the cost per quality-unit of frontier tier versus frontier cloud API is almost always worse. A £15,000 workstation amortised over three years is £5,000 a year. That buys you a lot of Claude Opus 4.8 tokens.
...
Rough break-even maths. A £12,000 build amortised over three years with power costs is about £450 per month. At Claude Opus 4.8 API rates ($5/M input, $25/M output), £450 buys roughly 30 million input tokens and 12 million output tokens. That's a lot of messages. If you're sending less than that volume monthly, cloud is cheaper.
