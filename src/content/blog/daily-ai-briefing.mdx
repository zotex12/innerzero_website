...
<PostImage
  ...
  alt="InnerZero Schedule page with a briefing request typed in plain language asking for the latest UK news by Telegram every Sunday at 7pm"
  width={2552}
  height={1338}
  caption="Setting up a recurring briefing in plain language on the Schedule page."
/>
