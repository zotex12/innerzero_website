...
The local model won't match the very largest frontier cloud models on the hardest tasks, but for everyday questions it works well. And the privacy trade-off is worth it for a lot of people.
