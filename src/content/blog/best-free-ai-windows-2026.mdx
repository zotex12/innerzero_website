...
- **7 themes.** Visual customisation [out of the box](/features/setup), including a High Contrast accessibility theme.
- **All free.** No trial, no subscription, no feature gates.

**Limitations:** Smaller models than cloud AI. Needs decent hardware for the best experience (16GB+ RAM, NVIDIA GPU recommended).
