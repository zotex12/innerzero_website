...
[Ollama](https://ollama.com) is the foundation that most local AI tools build on. It's a model runner. You install it, pull a model with a command like `ollama pull llama3`, and then interact with it through a terminal or API.
