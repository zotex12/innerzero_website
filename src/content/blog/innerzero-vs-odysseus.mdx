...
| Agent tasks | Yes | Yes |
| Connectors | Gmail, Google Calendar, and Telegram | IMAP, SMTP, CalDAV |
...
Both have memory. Odysseus stores it in a vector database as one feature in a wider workspace. InnerZero is built around [persistent memory](/features/memory) that accumulates automatically and is processed overnight, so it remembers you across sessions without any setup.
