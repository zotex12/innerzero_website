...
import { HeroScreenshots } from "@/components/sections/HeroScreenshots";
          ...
          __html: JSON.stringify([
            ...
            },
            {
              ...
              featureList: [
                ...
                "Proactive briefings and reminders",
                "Action Hub for web research and job applications",
                "Offline Wikipedia knowledge packs",
                "Screen automation",
                "Optional cloud AI via BYO API keys",
                "Choice of local AI engine: Ollama, LM Studio, or llama.cpp, or an Ollama server on your own network",
