      ...
      <Container>
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2">
            ...
            >
              See what&apos;s new in v0.2.2
            </Link>
          </p>
        </div>

        {/* v0.2.2 download-size note */}
            ...
            offers: [
              {
                ...
                url: "https://github.com/zotex12/innerzero-releases/releases/latest/download/InnerZero-Setup-0.2.2.exe",
              ...
              },
              {
                ...
                priceCurrency: "GBP",
                availability: "https://schema.org/InStock",
                url: "https://github.com/zotex12/innerzero-releases/releases/latest/download/InnerZero-Setup-0.2.2-mac.dmg",
              ...
              },
              {
                ...
                priceCurrency: "GBP",
                availability: "https://schema.org/InStock",
                url: "https://github.com/zotex12/innerzero-releases/releases/latest/download/InnerZero-0.2.2-x86_64.AppImage",
